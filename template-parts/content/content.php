...
$post_title_color = get_theme_mod('post_title_color', '#1f2937');
...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog-archive-post'); ?> data-style="<?php echo esc_attr($post_style); ?>" style="<?php echo esc_attr($article_style); ?>">
    <header class="entry-header">
        <?php the_title('<h2 class="entry-title" style="color: ' . esc_attr($post_title_color) . ';"><a href="' . esc_url(get_permalink()) . '" rel="bookmark">', '</a></h2>'); ?>
